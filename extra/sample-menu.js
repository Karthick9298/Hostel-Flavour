// Script to create a sample weekly menu for testing
const sampleMenu = {
  weekStartDate: "2025-10-06T00:00:00.000Z", // This week's Monday
  days: {
    monday: {
      morning: {
        items: [
...
console.log('Sample weekly menu structure:');
console.log(JSON.stringify(sampleMenu, null, 2));

console.log('\n\nTo create this menu via API:');
console.log('POST /api/menu/weekly');
